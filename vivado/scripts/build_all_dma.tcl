#===============================================================================
# Versal DMA Benchmark - Complete Design with All DMA Types
...
#   - LPD DMA: PS hard IP (enabled in CIPS, software access)
#===============================================================================
...
puts "============================================================"
puts "  Versal DMA Benchmark - All DMA Types"
puts "  VPK120 + LPDDR4"
puts "============================================================"
...
# Enable M_AXI_FPD for DMA control and interrupts for all DMAs
...
#===============================================================================
# AXI DMA - Stream based with loopback
#===============================================================================
puts "Adding AXI DMA..."
...
# Data paths: DMAs -> NoC
# NOTE: Each DMA SmartConnect needs inputs for: MM2S, S2MM, and SG (Scatter-Gather)
...
# CRITICAL: Connect M_AXI_SG for Scatter-Gather descriptor access
...
# MCDMA stream loopback (channel 0 only for simplicity)
...
set xsa_path "$project_dir/design_all_dma.xsa"
...
puts "  - AXI DMA:   Stream MM2S/S2MM with loopback FIFO"
puts "  - AXI MCDMA: 4-channel stream with loopback FIFO"
puts "  - LPD DMA:   PS hard IP (software access via CIPS)"
puts ""
puts "Memory Map:"
